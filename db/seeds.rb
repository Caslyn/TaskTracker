...
t5 = p2.trackers.new(project_id: p2.id, title: "icebox", visible: true, ord: 0)
t6 = p2.trackers.new(project_id: p2.id, title: "backlog", visible: true, ord: 1)
t7 = p2.trackers.new(project_id: p2.id, title: "current", visible: true, ord: 2)
t8 = p2.trackers.new(project_id: p2.id, title: "done", visible: true, ord: 3)
